...
namespace HutongGames.PlayMaker.Actions
{
	public sealed class Tk2dPlayRandomAnimationWithEvents : FsmStateAction
	{
		...
		private void DoPlayAnimationWithEvents()
		{
			...
			string clipName = clipNames.stringValues[UnityEngine.Random.Range(0, clipNames.Length)];
			IHeroAnimationController component = _sprite.GetComponent<IHeroAnimationController>();
			expectedClip = ((component != null) ? component.GetClip(clipName) : _sprite.GetClipByName(clipName));
