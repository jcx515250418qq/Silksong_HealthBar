		...
		public override void OnEnter()
		{
			...
			if (value != null)
			{
				...
				for (int i = 1; i <= num; i++)
				{
					...
					{
						float x = gameObject.transform.position.x + UnityEngine.Random.Range(0f - originVariation.Value, originVariation.Value);
						float y = gameObject.transform.position.y + UnityEngine.Random.Range(0f - originVariation.Value, originVariation.Value);
