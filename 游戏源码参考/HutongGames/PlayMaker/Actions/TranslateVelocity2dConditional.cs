...
namespace HutongGames.PlayMaker.Actions
{
	...
	public sealed class TranslateVelocity2dConditional : ComponentAction<Rigidbody2D>
	{
		...
		private void DoSetVelocity()
		{
			...
			Vector2 vector = ((!this.vector.IsNone) ? this.vector.Value : base.rigidbody2d.linearVelocity);
			bool flag = CheckCondition(vector.x, xCondition);
			bool flag2 = CheckCondition(vector.y, yCondition);
