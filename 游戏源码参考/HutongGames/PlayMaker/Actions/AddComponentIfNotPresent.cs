...
namespace HutongGames.PlayMaker.Actions
{
	...
	public class AddComponentIfNotPresent : FsmStateAction
	{
		...
		private void DoAddComponent()
		{
			...
			{
				Type globalType = ReflectionUtils.GetGlobalType(component.Value);
				addedComponent = ownerDefaultTarget.GetComponent(globalType) ?? ownerDefaultTarget.AddComponent(globalType);
