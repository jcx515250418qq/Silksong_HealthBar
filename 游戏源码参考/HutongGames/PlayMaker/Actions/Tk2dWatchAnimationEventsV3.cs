...
namespace HutongGames.PlayMaker.Actions
{
	...
	public class Tk2dWatchAnimationEventsV3 : FsmStateAction
	{
		...
		public override void Reset()
		{
			...
			sendTriggerEventIfAnimationChanged = null;
			sendCompleteEventIfAnimationChanged = null;
			animationInterruptedEvent = null;
		}
		...
		public override void OnUpdate()
		{
			...
			else if (checkChange && _sprite.CurrentClip != _currentClip)
			{
				base.Fsm.Event(animationInterruptedEvent);
				if (sendTriggerEventIfAnimationChanged.Value)
				{
					base.Fsm.Event(animationTriggerEvent);
				}
				if (sendCompleteEventIfAnimationChanged.Value)
				{
					base.Fsm.Event(animationCompleteEvent);
				}
				Finish();
		...
		private void DoWatchAnimationWithEvents()
		{
			...
			checkChange = animationCompleteEvent != null || sendTriggerEventIfAnimationChanged.Value || sendCompleteEventIfAnimationChanged.Value;
			_currentClip = _sprite.CurrentClip;
		}
